#pragma checksum "C:\Users\DPanchalTech\Documents\vishal\Dhawal_Construction\construction\App\Views\_adminsidebar.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "201d83f2835c3f99399951e195a36ce690191c39"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"201d83f2835c3f99399951e195a36ce690191c39", @"/Views/_adminsidebar.cshtml")]
...
");
        ...
        <li class=""nav-group"">
            <a class=""nav-link"" href=""\appartment\index"">
                <span class=""nav-icon""><i class=""fa-sharp fa-solid fa-apartment""></i></span>
                Appartment
            </a>
        </li>
        <li class=""nav-group"">
...
<div class=""sidebar sidebar-light sidebar-lg sidebar-end sidebar-overlaid hide"" id=""aside"">
    <div class=""sidebar-header bg-transparent p-0"">
        <button class=""sidebar-close"" type=""button"" data-coreui-close=""sidebar"">
            <svg class=""icon"">
                <use");
            BeginWriteAttribute("xlink:href", " xlink:href=\"", 4198, "\"", 4259, 2);
            WriteAttributeValue("", 4211, "~/proj/vendors/", 4211, 15, true);
            WriteLiteral("@");
            WriteAttributeValue("", 4228, "coreui/icons/svg/free.svg#cil-x", 4228, 31, true);
            EndWriteAttribute();
            WriteLiteral("></use>\r\n            </svg>\r\n        </button>\r\n    </div>\r\n</div>\r\n");
        }
